          ...
          <div className="col-lg-8 offset-lg-1 col-md-8">
            <div className="text">
              <Split>
                ...
                Our worldwide, multi disciplinary groups have a profound, pragmatic comprehension of monetary administrations and the difficulties you face. For north of thirty years, a considerable lot of the worlds top banks have confided in us to configuration, construct and run strategic arrangements. We can assist you with changing from heritage to computerized innovation.
                          </p>
              </Split>
            </div>
          </div>
